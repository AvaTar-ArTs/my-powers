...
```
Clone https://github.com/AvaTar-ArTs/my-powers to ~/.config/opencode/superpowers, then create directory ~/.config/opencode/plugins, then symlink ~/.config/opencode/superpowers/.opencode/plugins/superpowers.js to ~/.config/opencode/plugins/superpowers.js, then symlink ~/.config/opencode/superpowers/skills to ~/.config/opencode/skills/superpowers, then restart opencode.
```
...
git clone https://github.com/AvaTar-ArTs/my-powers.git "%USERPROFILE%\.config\opencode\superpowers"
...
```powershell
# 1. Install Superpowers
git clone https://github.com/AvaTar-ArTs/my-powers.git "$env:USERPROFILE\.config\opencode\superpowers"
...
- Report issues: https://github.com/AvaTar-ArTs/my-powers/issues
- Main documentation: https://github.com/AvaTar-ArTs/my-powers
