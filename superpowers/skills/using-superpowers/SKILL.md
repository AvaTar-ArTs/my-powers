...
> **Supremepower / multi-host bundle:** Full superpowers text: Instruction Priority, platform-specific access (Claude Code, Copilot CLI, Gemini CLI, extension hosts), and `references/` for tool mapping. Kept in sync with `core/skills/using-superpowers/`.
