...
| `/Users/steven/supremepowers/docs/imported-qwen/docs/evolution-changelogs` | `CAUTION` | Historical snapshot docs; append context carefully, do not rewrite history as live truth. |
...
| `/Users/steven/supremepowers/docs/imported-qwen/docs/evolution-changelogs` | Historical evolution snapshots | `CAUTION` | Prior session exports | Reference only (do not treat as live canonical) |
