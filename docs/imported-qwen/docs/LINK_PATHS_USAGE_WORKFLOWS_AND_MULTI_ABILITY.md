...
| Hooks policy docs | `/Users/steven/supremepowers/docs/imported-qwen/docs/HOOKS_MODEL_AND_IMPLEMENTATION.md` | Canonical hook semantics. |
| Integration adapters | `~/.qwen/integrations/supremepower/` | Cross-host adapter surface. |
| Recall/index docs | `/Users/steven/supremepowers/docs/imported-qwen/Master_Recall_Index.md`, `/Users/steven/supremepowers/docs/imported-qwen/QWEN_INVOKE_INDEX_BY_TYPE.md` | Goal-based and type-based discovery. |
...
- `/Users/steven/supremepowers/docs/imported-qwen/QWEN_INVOKE_INDEX_BY_TYPE.md`
- `/Users/steven/supremepowers/docs/imported-qwen/docs/LANGUAGE_AND_REFERENCE_STANDARD.md`
