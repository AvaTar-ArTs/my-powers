...
**Canonical path:** `/Users/steven/supremepowers/docs/imported-qwen/docs/model-providers-free-and-byok.md`  
...
Ecosystem changelog: `/Users/steven/supremepowers/docs/imported-qwen/docs/CHANGELOG.md` — log material edits to `settings.json` or this guide there when appropriate.
