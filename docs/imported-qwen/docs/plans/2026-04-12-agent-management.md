...
**Files:**
- Delete: `/Users/steven/supremepowers/docs/imported-qwen/agents-from-cursor/` (entire directory, 25 files, 176 KB)
...
**Command:**
```bash
rm -rf /Users/steven/supremepowers/docs/imported-qwen/agents-from-cursor/
echo "✅ agents-from-cursor/ deleted (176 KB freed)"
```

**Verification:** `ls /Users/steven/supremepowers/docs/imported-qwen/agents-from-cursor/` → "No such file or directory"
...
**Files:**
- Delete: `/Users/steven/supremepowers/docs/imported-qwen/superpowers/skills/skill-triggering/` (empty directory, no SKILL.md)
...
**Command:**
```bash
rm -rf /Users/steven/supremepowers/docs/imported-qwen/superpowers/skills/skill-triggering/
echo "✅ superpowers/skills/skill-triggering/ deleted"
```

**Verification:** `ls /Users/steven/supremepowers/docs/imported-qwen/superpowers/skills/skill-triggering/` → "No such file or directory"
...
**Files:**
- Delete: `/Users/steven/supremepowers/docs/imported-qwen/skills/superpowers-skill-triggering` (broken symlink)

**Rationale:** Points to deleted `superpowers/skills/skill-triggering/`. Broken symlink serves no purpose.

**Command:**
```bash
rm -f /Users/steven/supremepowers/docs/imported-qwen/skills/superpowers-skill-triggering
echo "✅ Broken symlink deleted"
```

**Verification:** `ls -la /Users/steven/supremepowers/docs/imported-qwen/skills/superpowers-skill-triggering` → "No such file or directory"
...
**Files:**
- Create: `/Users/steven/supremepowers/docs/imported-qwen/agents/REGISTRY.md`
...
**Files to check:**
- `/Users/steven/supremepowers/docs/imported-qwen/agents/` — should have 43 agent files + 2 reference docs + REGISTRY.md = 46 files
- `/Users/steven/supremepowers/docs/imported-qwen/skills/superpowers-skill-triggering` — should NOT exist
- `/Users/steven/supremepowers/docs/imported-qwen/superpowers/skills/skill-triggering/` — should NOT exist
- `/Users/steven/supremepowers/docs/imported-qwen/agents-from-cursor/` — should NOT exist

**Verification commands:**
```bash
echo "=== Agent count ==="
ls -1 /Users/steven/supremepowers/docs/imported-qwen/agents/ | wc -l

echo "=== Verify orphans removed ==="
test -d /Users/steven/supremepowers/docs/imported-qwen/agents-from-cursor && echo "FAIL: still exists" || echo "✅ agents-from-cursor/ gone"
test -d /Users/steven/supremepowers/docs/imported-qwen/superpowers/skills/skill-triggering && echo "FAIL: still exists" || echo "✅ skill-triggering/ gone"
test -L /Users/steven/supremepowers/docs/imported-qwen/skills/superpowers-skill-triggering && echo "FAIL: still exists" || echo "✅ broken symlink gone"

echo "=== Final ~/.qwen size ==="
du -sh /Users/steven/supremepowers/docs/imported-qwen/
```
