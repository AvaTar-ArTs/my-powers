...
- **Canonical policy**: `/Users/steven/supremepowers/docs/imported-qwen/docs/HOOKS_MODEL_AND_IMPLEMENTATION.md`
...
- `/Users/steven/supremepowers` — Canonical source in this clone (historically symlinked from `~/.qwen/skills/superpowers-*` on the authoring machine).
...
(`/Users/steven/supremepowers/`) ecosystems. Adapted supremepower infrastructure
...
- `/Users/steven/supremepowers` — Canonical superpowers source (this repository).
...
- **`docs/SOURCE_OF_TRUTH_AND_LAYERS.md`** — Formal model for:
  - canonical authoring (`/Users/steven/supremepowers/skills/`)
...
- **`IMPORT_MANIFEST.md`** — Corrected superpowers provenance to canonical authoring at `/Users/steven/supremepowers/skills/`.
...
### Findings
- **Canonical authoring target:** `/Users/steven/supremepowers/skills/using-superpowers/SKILL.md`
...
### Items Updated
- **`/Users/steven/supremepowers/skills/using-superpowers/`** — Promoted newer upstream candidate content and tool-mapping references into the canonical authoring target.
