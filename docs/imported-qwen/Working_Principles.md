...
**Principles to apply across Qwen sessions so behavior stays consistent and improves over time.** **Full system:** /Users/steven/supremepowers/docs/imported-qwen/QWEN_SYSTEM_DEFINITION.md (entire Qwen system: principles, language, paths, usage, all logics and flows, multi-ability).
